...
export class News extends Component {
  ...
  static propTypes={
    ...
    async updateNews(pageNo){
        ...
        const url = `https://newsapi.org/v2/top-headlines?country=${this.props.country}&category=${this.props.category}&apikey=10b2dab8abad475ba12a3ed8a529cbdb&page=${this.state.page}&pageSize=${this.props.pageSize}`;
